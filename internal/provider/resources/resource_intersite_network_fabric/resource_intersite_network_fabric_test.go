...
package resource_intersite_network_fabric
...
func TestResourceIntersiteNetworkFabric(t *testing.T) {
	type args struct {
		rscType  string
		rscName  string
		dataFile string
	...
	tests := []struct {
		...
		{
			name: "Test_resource_intersite_network_fabric",
			args: args{
				rscType:  "resource",
				rscName:  "intersite_network_fabric",
				dataFile: "/examples/ndfc_payloads/data_intersite_network_fabric.json",
			},
		},
	}
