...
func TestResourceFabricLanClassic(t *testing.T) {
	type args struct {
		rscType  string
		rscName  string
		dataFile string
	...
	tests := []struct {
		...
		{
			name: "Test_resource_fabric_lan_classic",
			args: args{
				rscType:  "resource",
				rscName:  "fabric_lan_classic",
				dataFile: "/examples/ndfc_payloads/data_fabric_lan_classic.json",
			},
		},
	}
