...
import (
	...
	"terraform-provider-ndfc/internal/provider/resources/resource_interface_loopback"
...
func (r *interfaceLoopbackResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + ndfc.ResourceLoopbackInterface
}

func (r *interfaceLoopbackResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_interface_loopback.InterfaceLoopbackResourceSchema(ctx)
}

func (d *interfaceLoopbackResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *interfaceLoopbackResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var in resource_interface_loopback.InterfaceLoopbackModel
...
func (r *interfaceLoopbackResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var planData resource_interface_loopback.InterfaceLoopbackModel
	var stateData resource_interface_loopback.InterfaceLoopbackModel
	var configData resource_interface_loopback.InterfaceLoopbackModel
...
func (r *interfaceLoopbackResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	data.Interfaces = types.MapNull(resource_interface_loopback.InterfacesValue{}.Type(ctx))
	resp.Diagnostics.Append(resp.State.Set(ctx, data)...)
...
func (r interfaceLoopbackResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data resource_interface_loopback.InterfaceLoopbackModel
