...
import (
	...
	"terraform-provider-ndfc/internal/provider/resources/resource_intersite_network_fabric"
...
func (r *fabricIntersiteNetworkResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_intersite_network_fabric.IntersiteNetworkFabricResourceSchema(ctx)
}
...
func (r *fabricIntersiteNetworkResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_intersite_network_fabric.IntersiteNetworkFabricModel
...
func (r *fabricIntersiteNetworkResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var planData resource_intersite_network_fabric.IntersiteNetworkFabricModel
	var stateData resource_intersite_network_fabric.IntersiteNetworkFabricModel
